...
public class BatchStatusHelperTests
{
    ...
    public void BuildGridRows_WhenRequiredColumnMissing_Throws()
    {
        var table = new MonitoringTableResult(
            ["pnldate", "SourceSystemName", "ConsoIsDone", "DatetimeEndCalculation", "DatetimeEndExtraction"],
    ...
    {
        var table = new MonitoringTableResult(
            ["pnldate", "SourceSystemName", "ConsoIsDone", "CalculationIsDone", "DatetimeEndCalculation", "DatetimeEndExtraction"],
            [new List<string?> { "2026-03-31", "Summit", "1", "1", "2026-04-01 13:45:30", "2026-04-01 14:10:05" }]);
        ...
        Assert.Equal("Summit", row.SourceSystemName);
    ...
    public void BuildGridRows_WhenEitherFlagIsNotOne_SetsStatusToKo()
    {
        var table = new MonitoringTableResult(
            ["pnldate", "SourceSystemName", "ConsoIsDone", "CalculationIsDone", "DatetimeEndCalculation", "DatetimeEndExtraction"],
            [new List<string?> { "2026-03-31", "Murex", "1", "0", "2026-04-01 13:45:30", "2026-04-01 14:10:05" }]);
    ...
    public void BuildGridRows_WhenDateTimesAreNull_UsesDashPlaceholders()
    {
        var table = new MonitoringTableResult(
            ["pnldate", "SourceSystemName", "ConsoIsDone", "CalculationIsDone", "DatetimeEndCalculation", "DatetimeEndExtraction"],
            [new List<string?> { "2026-03-31", null, "0", "0", null, null }]);
        ...
        Assert.Equal("31-03-2026", row.PnlDate);
        Assert.Equal("-", row.SourceSystemName);
