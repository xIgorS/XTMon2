...
public sealed class DeploymentCheckService : IDeploymentCheckService
{
    ...
    public DeploymentCheckService(
        ...
        IOptions<FunctionalRejectionOptions> functionalRejectionOptions,
        ...
        IOptions<UamAuthorizationOptions> uamOptions)
    {
        ...
        _checks = BuildChecks(
            ...
            functionalRejectionOptions.Value,
    ...
    private static IReadOnlyList<(string, string)> BuildChecks(
        ...
        FunctionalRejectionOptions functionalRejection,
        ...
        UamAuthorizationOptions uam)
    {
        var checks = new List<(string, string)>
        {
            ...
            (functionalRejection.MenuConnectionStringName, functionalRejection.SourceSystemTechnicalRejectStoredProcedure),
            (functionalRejection.StagingConnectionStringName, functionalRejection.TechnicalRejectStoredProcedure),
            (functionalRejection.DtmConnectionStringName, functionalRejection.TechnicalRejectStoredProcedure),
