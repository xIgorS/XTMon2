...
public partial class MultipleFeedVersion : ComponentBase
{
    ...
    private async Task LoadPnlDatesAsync()
    {
        ...
        {
            Logger.LogWarning(ex, "Unable to load default PNL dates for Multiple Feed Version.");
        }
    }
    ...
    private async Task RunAsync()
    {
        ...
        try
        {
            var response = await Repository.GetMultipleFeedVersionAsync(selectedPnlDate.Value, CancellationToken.None);
