...
public partial class FactPvCaConsistency : ComponentBase, IDisposable
{
    ...
    private const string MonitoringSubmenuKey = "fact-pv-ca-consistency";
    ...
    private async Task RestoreLatestJobAsync()
    {
        ...
        {
            Logger.LogWarning(ex, "Unable to restore latest Fact PV/CA Consistency job for PnlDate {PnlDate}.", selectedPnlDate.Value);
        }
    }
