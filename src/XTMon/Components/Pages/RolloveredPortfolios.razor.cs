...
public partial class RolloveredPortfolios : ComponentBase
{
    ...
    private async Task LoadPnlDatesAsync()
    {
        ...
        {
            Logger.LogWarning(ex, "Unable to load default PNL dates for Rollovered Portfolios.");
        }
    }
    ...
    private async Task RunAsync()
    {
        ...
        try
        {
            var response = await Repository.GetRolloveredPortfoliosAsync(selectedPnlDate.Value, CancellationToken.None);
