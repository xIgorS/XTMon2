...
public partial class RejectedXtgPortfolio : ComponentBase, IDisposable
{
    ...
    private const string MonitoringSubmenuKey = "rejected-xtg-portfolio";
    ...
    private async Task RestoreLatestJobAsync()
    {
        ...
        {
            Logger.LogWarning(ex, "Unable to restore latest Rejected XTG Portfolio job for PnlDate {PnlDate}.", selectedPnlDate.Value);
        }
    }
