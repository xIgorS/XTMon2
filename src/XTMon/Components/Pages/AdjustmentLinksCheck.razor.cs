...
public partial class AdjustmentLinksCheck : ComponentBase, IDisposable
{
    ...
    private const string MonitoringSubmenuKey = "adjustment-links-check";
    ...
    private async Task RestoreLatestJobAsync()
    {
        ...
        {
            Logger.LogWarning(ex, "Unable to restore latest Adjustment Links Check job for PnlDate {PnlDate}.", selectedPnlDate.Value);
        }
    }
