...
public partial class TradingVsFivrCheck : ComponentBase, IDisposable
{
    ...
    private const string MonitoringSubmenuKey = "trading-vs-fivr-check";
    ...
    private async Task RestoreLatestJobAsync()
    {
        ...
        {
            Logger.LogWarning(ex, "Unable to restore latest Trading vs Fivr Check job for PnlDate {PnlDate}.", selectedPnlDate.Value);
        }
    }
