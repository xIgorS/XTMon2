...
public partial class FutureCash : MonitoringTableJobPageBase<FutureCash>
{
    ...
    protected override string MonitoringSubmenuKey => "future-cash";
    protected override string MonitoringJobName => "Future Cash";
