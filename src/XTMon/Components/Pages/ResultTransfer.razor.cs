...
public partial class ResultTransfer : ComponentBase
{
    ...
    private async Task LoadPnlDatesAsync()
    {
        ...
        {
            Logger.LogWarning(ex, "Unable to load default PNL dates for Result Transfer.");
        }
    }
    ...
    private async Task RunAsync()
    {
        ...
        try
        {
            var response = await Repository.GetResultTransferAsync(selectedPnlDate.Value, CancellationToken.None);
