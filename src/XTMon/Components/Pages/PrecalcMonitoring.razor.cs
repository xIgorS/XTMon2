...
public partial class PrecalcMonitoring : ComponentBase, IDisposable
{
    ...
    private const string MonitoringSubmenuKey = "precalc-monitoring";
    ...
    private async Task RestoreLatestJobAsync()
    {
        ...
        {
            Logger.LogWarning(ex, "Unable to restore latest Precalc Monitoring job for PnlDate {PnlDate}.", selectedPnlDate.Value);
        }
    }
