...
public partial class MissingSogCheck : ComponentBase
{
    ...
    private async Task LoadPnlDatesAsync()
    {
        ...
        {
            Logger.LogWarning(ex, "Unable to load default PNL dates for Missing SOG Check.");
        }
    }
    ...
    private async Task RunAsync()
    {
        ...
        try
        {
            var response = await Repository.GetMissingSogCheckAsync(selectedPnlDate.Value, CancellationToken.None);
