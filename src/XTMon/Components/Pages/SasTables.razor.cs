...
public partial class SasTables : MonitoringTableJobPageBase<SasTables>
{
    ...
    protected override string MonitoringSubmenuKey => "sas-tables";
    protected override string MonitoringJobName => "Sas Tables";
