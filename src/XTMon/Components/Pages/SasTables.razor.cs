...
public partial class SasTables : ComponentBase
{
    ...
    private async Task LoadPnlDatesAsync()
    {
        ...
        {
            Logger.LogWarning(ex, "Unable to load default PNL dates for Sas tables.");
        }
    }
    ...
    private async Task RunAsync()
    {
        ...
        try
        {
            var response = await Repository.GetSasTablesAsync(selectedPnlDate.Value, CancellationToken.None);
