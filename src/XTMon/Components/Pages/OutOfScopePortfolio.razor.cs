...
public partial class OutOfScopePortfolio : ComponentBase, IDisposable
{
    ...
    private const string MonitoringSubmenuKey = "out-of-scope-portfolio";
    ...
    private async Task RestoreLatestJobAsync()
    {
        ...
        {
            Logger.LogWarning(ex, "Unable to restore latest Out of Scope Portfolio job for PnlDate {PnlDate}.", selectedPnlDate.Value);
        }
    }
