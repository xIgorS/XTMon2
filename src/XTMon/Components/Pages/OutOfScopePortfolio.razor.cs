...
public partial class OutOfScopePortfolio : MonitoringTableJobPageBase<OutOfScopePortfolio>
{
    ...
    protected override string MonitoringSubmenuKey => "out-of-scope-portfolio";
    protected override string MonitoringJobName => "Out of Scope Portfolio";
