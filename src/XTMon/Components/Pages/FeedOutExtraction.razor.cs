...
public partial class FeedOutExtraction : ComponentBase
{
    ...
    private async Task LoadPnlDatesAsync()
    {
        ...
        {
            Logger.LogWarning(ex, "Unable to load default PNL dates for FeedOut Extraction.");
        }
    }
    ...
    private async Task RunAsync()
    {
        ...
        catch (Exception ex)
        {
            Logger.LogError(
                ...
                ex,
                "Failed to load FeedOut Extraction for PnlDate {PnlDate}.",
    ...
    private async Task CopySqlToClipboardAsync()
    {
        ...
        {
            Logger.LogWarning(ex, "Unable to copy FeedOut Extraction SQL statement to clipboard.");
